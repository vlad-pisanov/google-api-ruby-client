...
require 'legacy/google/api_client/environment'
require 'legacy/google/api_client/discovery'
require 'legacy/google/api_client/request'
require 'legacy/google/api_client/reference'
require 'legacy/google/api_client/result'
require 'legacy/google/api_client/media'
require 'legacy/google/api_client/service_account'
require 'legacy/google/api_client/batch'
require 'legacy/google/api_client/gzip'
require 'legacy/google/api_client/charset'
require 'legacy/google/api_client/client_secrets'
require 'legacy/google/api_client/railtie' if defined?(Rails)
...
module Legacy
  module Google
    ...
    class APIClient
      include Legacy::Google::APIClient::Logging
      ...
      def initialize(options={})
        ...
        self.user_agent = options[:user_agent] || (
          "#{application_string} " +
          "google-api-ruby-client/#{Legacy::Google::APIClient::VERSION::STRING} #{ENV::OS_VERSION} (gzip)"
        ).strip
      ...
      # @return [Legacy::Google::APIClient::API] The service object.
        ...
        @directory_apis ||= (begin
          ...
          if self.directory_document && self.directory_document['items']
            self.directory_document['items'].map do |discovery_document|
              Legacy::Google::APIClient::API.new(
                document_base,
                discovery_document
              )
            end
      ...
      # @param [String] version The desired version of the API.
      #
      # @return [Legacy::Google::APIClient::Method] The method object.
      ...
      # Generates a request.
      #
      # @option options [Legacy::Google::APIClient::Method] :api_method
      ...
      #
      # @return [Legacy::Google::APIClient::Reference] The generated request.
      #
      # @example
      ...
      def generate_request(options={})
        ...
        return Legacy::Google::APIClient::Request.new(options)
      end
  
      ##
      # Executes a request, wrapping it in a Result object.
      #
      # @param [Legacy::Google::APIClient::Request, Hash, Array] params
      #   Either a Legacy::Google::APIClient::Request, a Hash, or an Array.
      #
      #   If a Legacy::Google::APIClient::Request, no other parameters are expected.
      #
      #   If a Hash, the below parameters are handled. If an Array, the
      #   parameters are assumed to be in the below order:
      #
      #   - (Legacy::Google::APIClient::Method) api_method:
      #     The method object or the RPC name of the method being executed.
      ...
      #
      # @return [Legacy::Google::APIClient::Result] The result from the API, nil if batch.
      #
      # @example
      ...
      #   )
      #
      # @see Legacy::Google::APIClient#generate_request
      def execute!(*params)
        if params.first.kind_of?(Legacy::Google::APIClient::Request)
      ...
      ##
      # Same as Legacy::Google::APIClient#execute!, but does not raise an exception for
      # normal API errros.
      #
      # @see Legacy::Google::APIClient#execute
      def execute(*params)
        begin
