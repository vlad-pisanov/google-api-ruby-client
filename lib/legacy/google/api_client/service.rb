...
require 'legacy/google/api_client/service/stub_generator'
require 'legacy/google/api_client/service/resource'
require 'legacy/google/api_client/service/request'
require 'legacy/google/api_client/service/result'
require 'legacy/google/api_client/service/batch'
...
module Legacy
  module Google
    class APIClient
      ...
      # Hides Legacy::Google::APIClient. Designed to be easier to use, with less code.
      #
      # @example
      #   calendar = Legacy::Google::APIClient::Service.new('calendar', 'v3')
      ...
      class Service
        ...
        def initialize(api_name, api_version, options = {})
          ...
          @client = Legacy::Google::APIClient.new(params)
          ...
          if options.include? :cache_store
            ...
            if (cache_exists && File.writable?(DEFAULT_CACHE_FILE)) ||
              ...
              @cache_store = Legacy::Google::APIClient::Service::SimpleFileStore.new(
                DEFAULT_CACHE_FILE)
            end
          end
        ...
        #          Legacy::Google::APIClient::Service::SimpleFileStore,
        #          nil]
        attr_reader :cache_store
  
        ##
        # Prepares a Legacy::Google::APIClient::BatchRequest object to make batched calls.
        # @param [Array] calls
        #   Optional array of Legacy::Google::APIClient::Service::Request to initialize
        ...
        def batch(calls = nil, &block)
          Legacy::Google::APIClient::Service::BatchRequest.new(self, calls, &block)
        end
        ...
        # executing.
        #
        # @param [Legacy::Google::APIClient::Service::Request,
        #         Legacy::Google::APIClient::Service::BatchCall] request
        #   The request to be executed.
        def execute(request)
          if request.instance_of? Legacy::Google::APIClient::Service::Request
            ...
            return Legacy::Google::APIClient::Service::Result.new(request, result)
          elsif request.instance_of? Legacy::Google::APIClient::Service::BatchRequest
