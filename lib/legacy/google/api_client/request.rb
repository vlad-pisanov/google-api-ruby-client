  ...
  module Google
    class APIClient
      ...
      class Request
        ...
        attr_reader :headers
        # @return [Legacy::Google::APIClient::Method] API method to invoke
        attr_reader :api_method
        # @return [Legacy::Google::APIClient::UploadIO] File to upload
        attr_accessor :media
        ...
        #   OAuth credentials
        # @option options [Legacy::Google::APIClient::UploadIO] :media
        ...
        def api_method=(new_api_method)
          if new_api_method.nil? || new_api_method.kind_of?(Legacy::Google::APIClient::Method)
            @api_method = new_api_method
          else
            raise TypeError,
              "Expected Legacy::Google::APIClient::Method, got #{new_api_method.class}."
          end
        end
        ...
        #
        # @return [Legacy::Google::APIClient::Result]
