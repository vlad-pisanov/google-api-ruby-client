...
require 'legacy/google/api_client/discovery/media'
  ...
  module Google
    class APIClient
      ...
      class API
        ...
        #   version.
        #
        # @return [Legacy::Google::APIClient::API] The constructed service object.
        ...
        #
        # @return [Hash] A list of {Legacy::Google::APIClient::Schema} objects.
        def schemas
          return @schemas ||= (
            (@discovery_document['schemas'] || []).inject({}) do |accu, (k, v)|
              accu[k] = Legacy::Google::APIClient::Schema.parse(self, v)
              accu
            end
          )
        end
        ...
        #
        # @return [Legacy::Google::APIClient::Schema] The associated Schema object.
        ...
        # API.
        #
        # @return [Array] A list of {Legacy::Google::APIClient::Resource} objects.
        def discovered_resources
          return @discovered_resources ||= (
            (@discovery_document['resources'] || []).inject([]) do |accu, (k, v)|
              accu << Legacy::Google::APIClient::Resource.new(
        ...
        # API.
        #
        # @return [Array] A list of {Legacy::Google::APIClient::Method} objects.
        def discovered_methods
          return @discovered_methods ||= (
            (@discovery_document['methods'] || []).inject([]) do |accu, (k, v)|
              accu << Legacy::Google::APIClient::Method.new(self, self.method_base, k, v)
              accu
            end
          )
        end
