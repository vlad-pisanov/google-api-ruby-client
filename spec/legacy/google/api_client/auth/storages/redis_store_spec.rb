...
describe Legacy::Google::APIClient::RedisStore do
  ...
  subject { Legacy::Google::APIClient::RedisStore.new('a redis instance') }
  ...
  describe 'redis_credentials_key' do
    ...
    context 'with given key' do
      let(:redis_store) { Legacy::Google::APIClient::RedisStore.new('a redis instance', 'another_google_api_credentials') }
