...
module Legacy
  module Google
    class APIClient
      ...
      #
      # @example
      #   chunk = Legacy::Google::APIClient::RangedIO.new(io, 0, 1000)
      class RangedIO 
        ##
      ...
      class ResumableUpload < Request
        ...
        #
        # @deprecated Pass the instance to {Legacy::Google::APIClient#execute} instead
        #
        # @param [Legacy::Google::APIClient] api_client
        ...
        def to_http_request
          if @complete
            raise Legacy::Google::APIClient::ClientError, "Upload already complete"
          elsif @offset.nil?
            self.headers.update({ 
              'Content-Length' => "0", 
        ...
        def process_http_response(response)
          ...
          return Legacy::Google::APIClient::Result.new(self, response)
        end
