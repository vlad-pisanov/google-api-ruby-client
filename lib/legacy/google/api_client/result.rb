  ...
  module Google
    class APIClient
      ...
      class Result
        ...
        # Init the result
        #
        # @param [Legacy::Google::APIClient::Request] request
        ...
        # @return [Legacy::Google::APIClient::Request] Original request object
        attr_reader :request
        ...
        # @return [Legacy::Google::APIClient::ResumableUpload] For resuming media uploads
        def resumable_upload        
          @media_upload ||= (
            ...
            Legacy::Google::APIClient::ResumableUpload.new(options)
          )
        end
        ...
        # 
        # @return [Legacy::Google::APIClient::Request]
        ...
        def next_page
          ...
          return Legacy::Google::APIClient::Request.new(
