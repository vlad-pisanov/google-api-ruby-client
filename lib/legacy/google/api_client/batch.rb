  ...
  module Google
    class APIClient
      ...
      class BatchRequest < Request
        ...
        # @api private
        # @return [Array<(String,Legacy::Google::APIClient::Request,Proc)] List of API calls in the batch
        attr_reader :calls
        ...
        #
        # @return [Legacy::Google::APIClient::BatchRequest]
        #   The constructed object.
        #
        # @yield [Legacy::Google::APIClient::Result]
        ...
        #
        # @param [Hash, Legacy::Google::APIClient::Request] call
        ...
        def add(call, call_id = nil, &block)
          unless call.kind_of?(Legacy::Google::APIClient::Reference)
            call = Legacy::Google::APIClient::Reference.new(call)
          end
          call_id ||= new_id
        ...
        def process_http_response(response)
          ...
          if m
            ...
            parts.each do |part|
              ...
              result = Legacy::Google::APIClient::Result.new(call, call_response)
              callback.call(result) if callback
            end
          end
          Legacy::Google::APIClient::Result.new(self, response)
        end
        ...
        #
        # @return [Legacy::Google::APIClient::BatchedCallResponse]
        ...
        # @api private
        #
        # @param [Legacy::Google::APIClient::Request] call
