  ...
  module Google
    class APIClient
      class Service
        ...
        # Wraps around the Legacy::Google::APIClient::Result class, making it easier to
        ...
        class Result
          ...
          # Init the result.
          #
          # @param [Legacy::Google::APIClient::Service::Request] request
          #   The original request
          # @param [Legacy::Google::APIClient::Result] base_result
          ...
          # @return [Legacy::Google::APIClient::Service::Request] Original request object
          attr_reader :request
          ...
          #
          # @return [Legacy::Google::APIClient::Service::Request]
