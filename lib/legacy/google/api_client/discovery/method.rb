  ...
  module Google
    class APIClient
      ...
      class Method
        ...
        #
        # @return [Legacy::Google::APIClient::API] The API this method belongs to.
        attr_reader :api
        ...
        #
        # @return [Legacy::Google::APIClient::MediaUpload] Description of upload endpoints
        def media_upload
          if @discovery_document['mediaUpload']
            return @media_upload ||= Legacy::Google::APIClient::MediaUpload.new(self, self.method_base, @discovery_document['mediaUpload'])
          else
            return nil
          end
        end
        ...
        #
        # @return [Legacy::Google::APIClient::Schema] The request schema.
        def request_schema
        ...
        #
        # @return [Legacy::Google::APIClient::Schema] The response schema.
        def response_schema
