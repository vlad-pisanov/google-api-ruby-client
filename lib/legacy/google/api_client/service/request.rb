    ...
    class APIClient
      class Service
        ...
        class Request
          ...
          # @param [Legacy::Google::APIClient::Method] method
          ...
          #
          # @return [Legacy::Google::APIClient::Service] The parent service.
          attr_reader :service
          ...
          # the request.
          #
          # @return [Legacy::Google::APIClient::Method] The API method description.
          attr_reader :method
