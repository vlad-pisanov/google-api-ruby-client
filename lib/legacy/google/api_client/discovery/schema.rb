      ...
      module Schema
        def self.parse(api, schema_data)
          ...
          if schema_name
            ...
            if Legacy::Google::APIClient::Schema.const_defined?(api_name_string, *args)
              api_name = Legacy::Google::APIClient::Schema.const_get(
                api_name_string, *args
              )
            else
              api_name = Legacy::Google::APIClient::Schema.const_set(
